...
public class SnappyProfilerViewer : EditorWindow {
    ...
    private UnityEditorInternal.Profiling.ProfilerColumn columnToSort = UnityEditorInternal.Profiling.ProfilerColumn.TotalTime;
    private UnityEditorInternal.Profiling.ProfilerColumn ColumnToSort {
        set {
    ...
    private void OnGUI() {
        ...
        */
        ...
        profilerProperty.SetRoot(SelectedFrame, UnityEditorInternal.Profiling.ProfilerColumn.DontSort, UnityEditorInternal.Profiling.ProfilerViewType.RawHierarchy);
        ...
        */
        ...
        headerLeftOffset = 0f;
        DrawColumnHeader("Function Name", UnityEditorInternal.Profiling.ProfilerColumn.FunctionName, functionNameHeaderWidth, columnHeadersStyleLeft);
        DrawColumnHeader("Total %", UnityEditorInternal.Profiling.ProfilerColumn.TotalPercent, numericalDataColumnWidth, columnHeadersStyleCentered);
        DrawColumnHeader("Self %", UnityEditorInternal.Profiling.ProfilerColumn.SelfPercent, numericalDataColumnWidth, columnHeadersStyleCentered);
        DrawColumnHeader("Calls", UnityEditorInternal.Profiling.ProfilerColumn.Calls, numericalDataColumnWidth, columnHeadersStyleCentered);
        DrawColumnHeader("GC Alloc", UnityEditorInternal.Profiling.ProfilerColumn.GCMemory, numericalDataColumnWidth, columnHeadersStyleCentered);
        DrawColumnHeader("Total ms", UnityEditorInternal.Profiling.ProfilerColumn.TotalTime, numericalDataColumnWidth, columnHeadersStyleCentered);
        DrawColumnHeader("Self ms", UnityEditorInternal.Profiling.ProfilerColumn.SelfTime, numericalDataColumnWidth, columnHeadersStyleCentered);
    ...
    private void UpdateFrameScrubberGraph(int width) {
        ...
        for(int f = 0; f < numberOfFrames; f++) {
            property.SetRoot(f + ProfilerDriver.firstFrameIndex, UnityEditorInternal.Profiling.ProfilerColumn.DontSort, UnityEditorInternal.Profiling.ProfilerViewType.RawHierarchy);
    ...
    private void DrawColumnHeader(string label, UnityEditorInternal.Profiling.ProfilerColumn column, float width, GUIStyle style) {
    ...
    private void UpdateProperties() {
        ProfilerProperty profilerProperty = new ProfilerProperty();
        profilerProperty.SetRoot(SelectedFrame, columnToSort, UnityEditorInternal.Profiling.ProfilerViewType.Hierarchy);
    ...
    private struct ProfilerRowInfo {
        ...
        public ProfilerRowInfo(ProfilerProperty profilerProperty) {
            ...
            functionName = profilerProperty.GetColumn(UnityEditorInternal.Profiling.ProfilerColumn.FunctionName);
            totalPercent = profilerProperty.GetColumn(UnityEditorInternal.Profiling.ProfilerColumn.TotalPercent);
            selfPercent = profilerProperty.GetColumn(UnityEditorInternal.Profiling.ProfilerColumn.SelfPercent);
            calls = profilerProperty.GetColumn(UnityEditorInternal.Profiling.ProfilerColumn.Calls);
            gcMemory = profilerProperty.GetColumn(UnityEditorInternal.Profiling.ProfilerColumn.GCMemory);
            totalTime = profilerProperty.GetColumn(UnityEditorInternal.Profiling.ProfilerColumn.TotalTime);
            selfTime = profilerProperty.GetColumn(UnityEditorInternal.Profiling.ProfilerColumn.SelfTime);
        }
    }
}
